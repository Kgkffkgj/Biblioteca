...
{
    public partial class LivrosAlterar : Form
    {
        public LivrosAlterar(int cod)
        {
            InitializeComponent();
        ...
        private void LivrosAlterar_Load(object sender, EventArgs e)
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            MySqlCommand Consulta = new MySqlCommand();
            Consulta.Connection = conectar;
            Consulta.CommandText = "UPDATE livros SET nome = '" + textBox1.Text + "',editora = '" + textBox2.Text + "',autor = '" + textBox3.Text + "',anoPublic = '" + textBox4.Text + "' WHERE idlivro = " + cod + ";";
            MySqlDataReader Resultado = Consulta.ExecuteReader();
            if (Resultado.HasRows)
            {
                while (Resultado.Read())
